...
public interface AppComponent {
    ...
    OnlineSubComponent onlineRecipeListSubComponent(OnlineRecipeModule onlineRecipeModule);
    RecipeFilterSubComponent discoverSubComponent(RecipeFilterModule recipeFilterModule);
}
