...
public class RecipeNutritionEditFragment extends Fragment implements RecipeNutritionContract.NutritionView {
    ...
    private void setList() {
        adapter = new RecipeNutritionEditAdapter(recipeNutritionListener.getMyRecipe().getNutritionList(), new RecipeNutritionContract.NutritionChangedListener() {

            @Override
            public void nutritionAmountChanged(Nutrition nutrition) {
                presenter.nutritionAmountChanged(recipeNutritionListener.getMyRecipe(), nutrition);
            }
            ...
            public void onRecipeTypeSelected(@NonNull Nutrition nutrition, TextView v) {
                ...
                popupMenu.setOnMenuItemClickListener(item -> {
                    ...
                    v.setText(type);
                    presenter.nutritionMeasurementChanged(recipeNutritionListener.getMyRecipe(), nutrition);
                    return true;
                });
                popupMenu.show();
            }
