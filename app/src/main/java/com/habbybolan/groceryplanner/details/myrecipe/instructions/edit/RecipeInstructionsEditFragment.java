...
public class RecipeInstructionsEditFragment extends Fragment implements RecipeInstructionsContract.RecipeInstructionsView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setToolbar();
        onTextChange();
        binding.editTxtInstructions.setText(recipeStepListener.getMyRecipe().getInstructions());
    ...
    private void saveInstructions() {
        ...
        recipeStepListener.getMyRecipe().setInstructions(instructions);
        presenter.updateRecipe(recipeStepListener.getMyRecipe());
    }
