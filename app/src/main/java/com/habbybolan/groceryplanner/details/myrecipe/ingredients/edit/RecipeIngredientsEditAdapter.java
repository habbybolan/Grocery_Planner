...
public class RecipeIngredientsEditAdapter extends ListAdapter<RecipeIngredientsEditAdapter.ViewHolder, Ingredient> {

    RecipeIngredientsEditAdapter(List<Ingredient> ingredients, ListViewInterface view) {
        super(view, ingredients);
    }

    @NonNull
    @Override
    public RecipeIngredientsEditAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecipeIngredientsEditAdapter.ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull RecipeIngredientsEditAdapter.ViewHolder holder, int position) {
