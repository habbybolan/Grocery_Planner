...
public class RecipeOverviewEditFragment extends Fragment implements RecipeOverviewContract.OverviewEditView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        presenter.fetchGroceriesNotHoldingRecipe(recipeOverviewListener.getMyRecipe());
        setToolbar();
        setRV();
        setTagClicker();
        initClickers();
    ...
    private void setTagClicker() {
        binding.recipeOverviewBtnAddTag.setOnClickListener(l -> {
            ...
            presenter.checkAddingRecipeTag(tagTitle, presenter.getLoadedRecipeTags(), recipeOverviewListener.getMyRecipe());
        });
    }
    ...
    private void saveRecipe() {
        ...
        presenter.updateRecipe(recipeOverviewListener.getMyRecipe(), name, servingSize, cookTime, prepTime, description, selectedRecipeCategory);
    }
    ...
    public void displayRecipeIngredients(List<IngredientWithGroceryCheck> ingredients, String[] ingredientNames, Grocery grocery) {
        ...
        builder.setTitle("Select Ingredients to add to Grocery")
                ...
                .setPositiveButton("Save", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            presenter.updateRecipeIngredientsInGrocery(recipeOverviewListener.getMyRecipe(), grocery, 1, ingredients);
                        } finally {
                ...
                .setNeutralButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            presenter.deleteRecipeFromGrocery(recipeOverviewListener.getMyRecipe(), grocery);
                        } finally {
                            // update the stored values holding the the groceries holding and not holding the recipe
                            presenter.fetchGroceriesNotHoldingRecipe(recipeOverviewListener.getMyRecipe());
                            presenter.fetchGroceriesHoldingRecipe(recipeOverviewListener.getMyRecipe());
        ...
        builder.setTitle("Grocery to add recipe to")
                ...
                .setItems(groceryNames, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        presenter.fetchRecipeIngredients(recipeOverviewListener.getMyRecipe(), groceries.get(which), true);
                    }
                });
        AlertDialog dialog = builder.create();
        dialog.show();
    ...
    public void onGroceryHoldingRecipeClicked(Grocery grocery) {
        ...
        presenter.fetchRecipeIngredients(recipeOverviewListener.getMyRecipe(), grocery, false);
    }
    ...
    public void updateTagDisplay() {
        tagRV.itemInserted(presenter.getLoadedRecipeTags().size()-1);
        binding.recipeOverviewTag.setText("");
    }

    @Override
    public void onDeleteRecipeTag(RecipeTag recipeTag) {
        presenter.deleteRecipeTag(recipeOverviewListener.getMyRecipe(), recipeTag);
    }
