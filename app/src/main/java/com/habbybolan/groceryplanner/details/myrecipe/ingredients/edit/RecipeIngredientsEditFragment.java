...
public class RecipeIngredientsEditFragment extends NonCategoryListFragment<Ingredient> implements RecipeIngredientsContract.IngredientsEditView {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        listItems = recipeIngredientsListener.getMyRecipe().getIngredients();
        presenter.createIngredientList(recipeIngredientsListener.getMyRecipe());
    }
    ...
    public void deleteSelectedItems() {
        presenter.deleteIngredients(recipeIngredientsListener.getMyRecipe(), listItemsChecked);
    }
    ...
    public void onListFetched(List<Ingredient> ingredients) {
        recipeIngredientsListener.getMyRecipe().setIngredients(ingredients);
     ...
     */
    public interface RecipeIngredientsListener extends RecipeIngredientsContract.RecipeIngredientsListener, ItemListener<Ingredient> {
